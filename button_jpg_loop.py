...
# テキストボックス
        ...
        self.txt1.insert(tkinter.END,"10")
...
# テキストボックス
        ...
        self.txt2.insert(tkinter.END,"10")
        ...
        self.txt3.insert(tkinter.END,"12")
        ...
        button3= Button(root, text=u'ファイル選択2', font=24,command=self.button8_clicked)  
        button3.grid(row=0, column=1)  
        button3.place(x=950, y=370) 
    
        button3= Button(root, text=u'ファイル選択3', font=24,command=self.button9_clicked)  
        button3.grid(row=0, column=1)  
        button3.place(x=950, y=470) 
    ...
    def setnumber(self):
        ...
        for file in self.filenames3:
            img3 = Image.open(file)
        image3 = img3.convert('RGB')

        for file in self.filenames4:
            img4 = Image.open(file)
        image4 = img4.convert('RGB')
        ...
        while(1):
            ...
            for i in range(column_max*row_max+1):
                ...
                if i > 0:
                    ...
                    self.r, self.g, self.b = image3.getpixel((column*column_step, row*row_step))
            ...
            for i in range(column_max*row_max+1):
                ...
                if i > 0:
                    ...
                    self.r, self.g, self.b = image4.getpixel((column*column_step, row*row_step))
